vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
        ...
        map('<C-s>', "<cmd>lua vim.lsp.buf.signature_help({offset_y = -2, relative='cursor', anchor_bias='above', focus=true })<CR>", 'Signature Help', { 'n', 'i', 's' })
        ...
        -- line diagnostics (stolen from lunarvim)
        map('gl', function()
